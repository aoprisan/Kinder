...
////    fn seq<F>(&self, <Self as HKT<F>>::T) -> Self::T where F: Fn(&Self::C) -> U, Self: HKT<F>;
//    fn seq<F>(&self, f: <Self as HKT<F>>::T) -> <Self as HKT<U>>::T where F: Fn(&<Self as HKT<U>>::C) -> U, Self: HKT<F>; //kinda ugly
//
//}
//
